...
let eeveeNavButtonSmartphone = document.getElementById("eevee-nav-button-smartphone");
eeveeNavButtonSmartphone.addEventListener("click", () => {
  switchPokemon.eeveeContent.replaceContent();
});
let flareonNavButtonSmartphone = document.getElementById("flareon-nav-button-smartphone");
flareonNavButtonSmartphone.addEventListener("click", () => {
  switchPokemon.flareonContent.replaceContent();
});
let jolteonNavButtonSmartphone = document.getElementById("jolteon-nav-button-smartphone");
jolteonNavButtonSmartphone.addEventListener("click", () => {
  switchPokemon.jolteonContent.replaceContent();
});
let vaporeonNavButtonSmartphone = document.getElementById("vaporeon-nav-button-smartphone");
